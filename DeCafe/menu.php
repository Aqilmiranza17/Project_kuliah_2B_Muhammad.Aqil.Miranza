            ...
            <div class="modal-body">
              ...
              <form class="needs-validation" novalidate action="proses/proses_input_menu.php" method="POST"
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div class="form-floating mb-3">
                      <input type="number" class="form-control" id="floatingInput" placeholder="Stock" name="stok"
                        required>
                ...
                <div class="modal-body">
                  <form class="needs-validation" novalidate action="proses/proses_input_menu.php" method="POST"
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="form-floating mb-3">
                          <input disabled type="number" class="form-control" id="floatingInput" value="<?= $row['stok'] ?>">
                          <label for="floatingInput">Stock</label>
                          <div class="invalid-feedback">
                            Masukkan Stock
                          </div>
                  ...
                  <form class="needs-validation" novalidate action="proses/proses_edit_menu.php" method="POST"
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-floating mb-3">
                          <input type="text" class="form-control" id="floatingInput" placeholder="Nama Menu"
                            name="nama_menu" required value="<?= $row['nama_menu'] ?>">
                          <label for="floatingInput">Nama Menu</label>
                          <div class="invalid-feedback">
                            Masukkan Nama Menu
                          </div>
                ...
                <tr>
                  ...
                  <td>
                    <div style="width: 90px;">
                      <img src="assets/image/<?= $row['foto'] ?>" class="img-thumbnail" alt="...">
                    </div>
                  </td>
                  <td>
                    <?= $row['nama_menu'] ?>
                  ...
                  <td>
                    <?= ($row['jenis_menu'] == 1) ? "Makanan" : "Minuman" ?>
                  </td>
                  <td>
                    <?= $row['kategori_menu'] ?>
                  </td>
