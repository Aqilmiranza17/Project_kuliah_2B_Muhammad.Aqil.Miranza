                      ...
                      <div class="col-lg-4">
                        <div class="form-floating mb-3">
                          <input disabled type="number" class="form-control" id="floatingInput" placeholder="Jumlah Porsi"
                            name="jumlah" required value="<?= $row['jumlah'] ?>">
                ...
                if ($row['status'] != 2) {
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <button
                          class="<?php echo (!empty($row['status'])) ? "btn btn-secondary btn-sm me-1 disabled text-nowrap" : "btn btn-primary btn-sm me-1 text-nowrap"; ?>"
                          data-bs-toggle="modal" data-bs-target="#terima<?php echo $row['id_list_order'] ?>">terima</button>
                        <button
                          class="<?php echo (empty($row['status']) || ($row['status']) != 1) ? "btn btn-secondary btn-sm me-1 disabled text-nowrap" : "btn btn-success btn-sm me-1 text-nowrap"; ?>"
                          data-bs-toggle="modal" data-bs-target="#siapsaji<?php echo $row['id_list_order'] ?>">siap
                          saji</button>
                      </div>
                    </td>
                  </tr>
